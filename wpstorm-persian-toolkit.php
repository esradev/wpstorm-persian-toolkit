...
class Wpstorm_Persian_Toolkit {
    ...
    private function define_constants() {
        define('WPSTORM_PT_PLUGIN_FILE', __FILE__);
        define('WPSTORM_PT_PLUGIN_DIR', plugin_dir_path(WPSTORM_PT_PLUGIN_FILE));
        define('WPSTORM_PT_PLUGIN_URL', plugin_dir_url(WPSTORM_PT_PLUGIN_FILE));
    ...
    private function load_dependencies() {
        ...
        require_once WPSTORM_PT_PLUGIN_DIR . 'classes/wpstorm-pt-settings.php';
        require_once WPSTORM_PT_PLUGIN_DIR . 'classes/wpstorm-pt-date-changer.php';
        require_once WPSTORM_PT_PLUGIN_DIR . 'classes/wpstorm-pt-font-changer.php';
        require_once WPSTORM_PT_PLUGIN_DIR . 'classes/wpstorm-pt-elementor.php';
    }
